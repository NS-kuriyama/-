...
<form action="http://localhost:8080/MemberInformation/jp.co.aforce/register" method="post">
	...
	<p>■名前</p>
	<p>
		姓<input type="text" name="last_name" max="32" required>
		名<input type="text" name="first_name" max="32" required>
	</p>
	<p>■性別</p>
	<p>
		<input type="radio" name="sex" id="man" value="1" required><label for="man">男</label>
		<input type="radio" name="sex" id="woman" value="2"required><label for="woman">女</label>
	<p>■生年月日</p>
	<p>
	...
	<p>■電話番号</p>
	<input type="number" name="phone_number" maxlength="32" required>
	<p>■メールアドレス</p>
